...
```bash
curl -fsSL https://raw.githubusercontent.com/heiytor/dotfiles/main/install.sh | bash
```
...
1. **Download the installer:**
   ```bash
   curl -fsSL https://raw.githubusercontent.com/heiytor/dotfiles/main/install.sh -o install.sh
   chmod +x install.sh
   ```
